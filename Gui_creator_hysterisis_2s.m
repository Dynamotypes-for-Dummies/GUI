...
fig = uifigure('Position', [20, 50, 1500, 750], 'Name', 'Class 2s', 'Color',[1,1,1]);
Height = 735;
% A slider
%%change caption here 
...
Height = Height - mindip;
%%change k value here
kkSlider = uislider(fig, 'Position', [50,Height, 500, 3], 'Limits', [-0.1, 0.1], 'Value', 0.0003);
...
Height = Height - mindip;
TmaxSlider = uislider(fig, 'Position', [50,Height, 500, 3], 'Limits', [100, 10000], 'Value', 400);
...
filename = sprintf('Class_2s_timeseries_Offset_index_%d_Onset_index_%d_dstar_%.2f_N_%.2f_k_%.2f_dynamical_noise_%.2f_Aqquisition_noise_%.2f_tMax_%.2f_frequency_%.2f_drift_%.2f.mat', ...
        AIndex, BIndex, dstar, N,k, sigma, acq_noise, tmax, frequency, drift);
